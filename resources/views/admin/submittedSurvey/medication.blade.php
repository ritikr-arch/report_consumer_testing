         ...
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="table-container white-space">

                     <table class="table table-hover mb-0">
                         <thead>
                            <tr class="">
                                <th style="background-color: #00a258 !important; color: white !important;" colspan="{{ 3 + count($markets)*2 }}"
                             ...
                             <tr class="border-b">
                                 ...
                                 @if(isset($markets) && count($markets) > 0)
                                     @foreach($markets as $market)
                                        <th colspan="2" class="text-center">{{ ucfirst($market->name) }} 
                                        </th>
                                     @endforeach
                                 @endif
                             </tr>
