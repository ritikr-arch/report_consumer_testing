                                ...
                                <select class="form-select" name="collected_buy" aria-label="Default select example">
                                   ...
                                   @if(isset($assignies) && count($assignies) > 0)
                                    @foreach($assignies as $ctrKey => $coltrrValue)
                                        <option 
                                            {{ request('collected_buy') == $coltrrValue->id ? 'selected' : '' }} 
                                            value="{{ $coltrrValue->id }}">
                                            {{ $coltrrValue->title ? ucfirst($coltrrValue->title) . ' ' : '' }}{{ ucfirst($coltrrValue->name) }}
                                        </option>
                                    @endforeach
                                @endif
...
<!-- 
                                <select class="form-select" name="updated_by" aria-label="Default select example">

                                    <option value="" selected="">Updated By</option>

                                    @if(isset($updaters) && count($updaters)>0)

                                    @foreach($updaters as $upKey=>$updtrValue)

                                    <option {{ request('updated_by') == $updtrValue->id ? 'selected' : '' }}
                                        value="{{$updtrValue->id}}">{{ucfirst($updtrValue->name)}}</option>
                        ...
                        <!--         <select class="form-select" name="status" aria-label="Default select example">
                                ...
                                <div class="filter-date">
                                   ...
                                   <!--  <label for="end-date">Collected Date</label> -->
                               ...
                               <!--      <label for="start-date">Start Date12</label> -->
                                ...
                                <thead>
                                    ...
                                    <tr class="border-b bg-light2">
                                        ...
                                        <th style="min-width: 140px;">Collected Date</th>
                                         <th style="min-width: 140px;">is submit</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{  customt_date_format( $value->created_at) }}</td>
                                           <td>@if($value->is_submit == '1')
                                                    Yes 
                                                @elseif($value->is_submit == '0')
                                                No  
                                                @endif</td>
                                        <td>{{($value->submitter)?$value->submitter->title:''}} {{($value->submitter)?$value->submitter->name:''}}</td>
