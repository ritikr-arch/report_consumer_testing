        ...
        <div class="card">
          <div class="card-body">
            <div class="row align-items-center d-flex mb-3">
              <div class="col-xl-12">
                <h4 class="header-title mb-0 font-weight-bold" style="font-size:24px;"> Import Commodity </h4>
              </div>
            </div>
            <form action="{{ route('admin.commodity.import.post') }}" method="POST" enctype="multipart/form-data"> @csrf <div class="row mt-3">
                <div class="col-md-5">
                ...
                <div class="col-md-2 mt-3">
                  <a href="{{ asset('admin/sample/commodity-sample.xlsx') }}" class="import-btn" download>Download Sample</a>
                </div>
              </div>
            </form>
          </div>
