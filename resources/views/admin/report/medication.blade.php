               ...
               <div class="card-body">
                    ...
                    <div class="col-xl-6">
                        <div class="search-btn1 text-end">
                            ...
                            <a class="btn btn-secondary btn-sm"
                                href="{{ route('admin.submitted.survey.medication.report.export', array_merge(request()->query(), ['id' => request()->query('id', $id)])) }}"
                                ...
                                <select class="form-select" name="status" aria-label="Default select example">
                                 ...
                                 <div class="filter-date">
                                   ...
                                   <!--  <label for="start-date">Start Date</label> -->
                                    ...
                                    <input type="text" value="{{ request('start_date') }}" name="start_date" class="form-control" placeholder="Start Date" autocomplete="off">
                                 ...
                                 <!--    <label for="end-date">End Date</label> -->
                                    ...
                                    <input type="text" value="{{ request('end_date') }}"  name="end_date" class="form-control" placeholder="Start Date" autocomplete="off">
                  ...
                  <div class="table-responsive white-space">
                     ...
                     <table class="table table-hover mb-0 w-100">
                         <thead>
                             <tr class="border-b">
                                 <th class="sticky-1" rowspan="2">Commodities</th>
                                 {{-- <th class="sticky-2" rowspan="2">Brand</th> --}}
                                 <th class="sticky-2" rowspan="2">Content</th>
                         ...
                         <tbody>
                            @if(isset($data) && count($data) > 0)
                                @foreach($data as $categoryName => $categoryData)
                                    <tr>
                                        <td colspan="{{ 3 + (count($markets)*2) }}" class="bg-light fw-bold">
                                    ...
                                    @foreach($categoryData->groupBy('commodity_id') as $commodityId => $commodityData)
                                        @php 
                                            ...
                                            $uniquePrices = $commodityData->pluck('amount', 'amount_1')->unique()->values();
                                        ...
                                        <tr>
                                            ...
                                            <td class="sticky-2">{{ $firstRow->unit->name ?? 'No Name' }}</td>
