        ...
        <div class="card">
          <div class="card-body">
            <div class="row align-items-center d-flex mb-3">
              <div class="col-xl-7">
                <h4 class="header-title mb-0 font-weight-bold"> Notices </h4>
              </div>
              <div class="col-12 col-md-5 col-lg-5 text-end">
                <div>
                  @can('notices_create')
                  <div>
                    <button class="d-fle btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" data-toggle="tooltip" data-placement="top" title="Create Notices">
                      <i class="fa-solid fa-plus"></i>&nbsp; Notices </button>
                  </div>
                  @endcan
                </div>
              </div>
              ...
              <table class="table table-hover mb-0">
                <thead>
                  <tr class="border-b bg-light2">
                    ...
                    <th>Status</th>
                    @endcan
                    @canany(['notices_edit','notices_delete'])
                    <th>Action</th>
                    @endcan
                  </tr>
                </thead>
                <tbody> @if(isset($data) && count($data)>0) @foreach($data as $key=>$value) <tr>
                    ...
                    <td>
                      ...
                      <img src="{{asset('admin/images/notices/'. $value->link)}}" alt="{{ $value->title }}" style="width:60px;40px;">
                      @else
                      {{ '-' }}
                      @endif
                    </td>
                    ...
                    <td>
                      <div class="action-btn d-flex">
                        ...
                        @can('notices_delete')
                        <img data-toggle="tooltip" data-placement="top" title="Delete" src="{{asset('admin/img/trash.png')}}" data-id="{{$value->id}}" class="deleteNotices" alt="trash">
                        @endcan
                      </div>
                    </td>
                    @endcanany
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="heading">
          <h2 id="formHeading">Add Notices</h2>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label>Upload Image <span class="text-danger">*</span></label>
                <div class="upload-box" id="uploadBox">
                  ...
                  <input type="file" id="image" name="document" accept=".pdf,.doc,.docx,.jpeg,.png,.jpg">
                </div>
              ...
              <p>
                ...
                <!-- <a  id="editDocument" href="" target="blank" style="display: none;">View Document</a> -->
            ...
            <div class="col-md-12">
                        <label > Content <span class="text-danger">*</span> </label>
                            <div class="form-group ad-user">
                                <textarea class="form-control oye-f2" name="content" id="content"
            ...
            <div class="text-center">
              <button type="submit" class="btnsss btn-save">Add Notices</button>
            </div>
          </div>
        </form>
      </div>
...
// TinyMCE Init
  ...
  $(document).on('click', '.editcategory', function () {
    ...
    let url = "{{ route('admin.notices.edit', ':id') }}".replace(':id', id);
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.success) {
            ...
            $("#formHeading").text('Edit Notices');
            $(".btnsss").text('Update Notices');
  ...
  $('#exampleModal').on('hidden.bs.modal', function () {
    ...
    $("#formHeading").text('Add Notices');
    $(".btn-save").text('Add Notices');
