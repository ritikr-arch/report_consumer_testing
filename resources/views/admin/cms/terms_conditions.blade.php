...
<div class="px-3">
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('admin.terms.conditions.update')}}" method="post" id="terms_form" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center d-flex mb-3">
                                <div class="col-xl-12">
                                    <h4 class="header-title mb-0 font-weight-bold"> Terms & Conditions </h4>
                                </div>
                            </div>
