...
<div class="px-3">
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('admin.consumer.education.kids.update')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center d-flex mb-3">
                                <div class="col-xl-12">
                                    <h4 class="header-title mb-0 font-weight-bold"> Consumer Education For Kids Program  </h4>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-5">
                                    ...
                                    <input type="file" name="imagess" class="form-control" accept="image/*" style="margin-top:6px;"> 
