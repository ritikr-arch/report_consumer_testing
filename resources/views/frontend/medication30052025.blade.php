                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 col-12 mb-3">
                                                    <label id="type_error" for=""> Type <span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-4 col-12 mb-3" id="marketWraper">
                                                    <label id="market_error" for=""> Store <span class="text-danger">*</span></label>
