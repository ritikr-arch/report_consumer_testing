...
<div class="px-3">
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('admin.public.health.acts.update')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center d-flex mb-3">
                                <div class="col-xl-12">
                                    <h4 class="header-title mb-0 font-weight-bold"> Public Health Act </h4>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                            ...
                                            @enderror
                                                            ...
                                                            <div class="col-md-4">
                                    <label for="imageUpload">Image Upload <span class="text-danger">*</span></label>
                                    <input type="file" id="imageUpload" name="imagess" class="form-control" accept="image/*">
                                    <small id="imageError" class="text-danger text-bold d-block mt-1"></small>
                                    <p style="font-size: 11px; font-weight: 700;">
                                        Recommended Dimension -> 600x400 Pixels (Max) <br>
                                        Image size should not more than 5MB
                                    </p>
                                </div>
        ...
        if (file) {
            ...
            img.onload = function () {
                if (this.width > 600 || this.height > 400) {
                    errorElement.textContent = 'Image dimensions must be 600x400 pixels or less.';
                    event.target.value = '';
                }
            };
