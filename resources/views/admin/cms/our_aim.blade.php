...
<div class="px-3">
  <div class="container-fluid">
    <form action="{{route('admin.our.aim.update')}}" method="post" id="aim_form" enctype="multipart/form-data">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row align-items-center d-flex mb-3">
                <div class="col-xl-12">
                  <h4 class="header-title mb-0 font-weight-bold"> Our Aim </h4>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <label for="exampleFormControlInput1">Title <span class="text-danger">*</span>
                  </label>
                ...
                <div class="col-md-4">
                    ...
                    <p style="font-size: 11px; font-weight: 700;"> Recommended Dimension -> 64x64 Pixels (Max) </br> Image size should not more then 5MB </p>
                </div>
                <div class="col-md-2">
